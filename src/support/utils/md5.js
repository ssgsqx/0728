...
export default function objKeySort(arys) {
	let sign = 'a63765d766b24444bb2efc2e';
	let newStr = '';
	//console.log(arys)
	//先用Object内置类的keys方法获取要排序对象的属性名，再利用Array原型上的sort方法对获取的属性名进行排序，newkey是一个数组
	let newkey = Object.keys(arys).sort((a, b) => {
	...
	// console.log("newStrMD5:"+hex_md5((newStr.toLowerCase()+sign.toLowerCase()).toLowerCase()))
	let signStr = (newStr + sign).toLowerCase();
	console.log('signStr:' + signStr);
	return hex_md5(signStr).toUpperCase(); //返回排好序的新对象
}
/*
